...
module.exports = (client) => {
  ...
  app.get("/invite", (req, res) => {
    res.redirect("https://discordapp.com/oauth2/authorize?client_id=569546382667546643&scope=bot&permissions=37080064");
  });
  ...
  app.get("/", (req, res) => {
    ...
    const fs = require('fs');
    const currentlyplaying0 = JSON.parse(fs.readFileSync("./song.json"));
